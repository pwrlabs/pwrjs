...
import { PWRJS } from '../src/exports/main/index';

import Falcon512Wallet from '../src/wallet/falcon-wallet';

import crypto from 'crypto';
import { HashService } from '@pwrjs/core-beta/services';
import FalconServiceNode from '../src/services/falcon-node.service';
...
describe('', () => {
    ...
    test('test service itself', async () => {
        ...
        const valid = await FalconServiceNode.verify(message, keypair.pk, signature);
